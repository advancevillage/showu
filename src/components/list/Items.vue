<template>
    <div>
        ...
        <div class="items">
            <div class="card" v-for="(item, index) in goods.total" :key="index">
                ...
                <div class="card-content">
                    ...
                    <div class="color">
                        <b-tag class="color_warp" v-for="(item, index) in color.context" :key="index" v-bind:style="{'background-color': item}"></b-tag>
                    </div>
                </div>
            </div>
        </div>
